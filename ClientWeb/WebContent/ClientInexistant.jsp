...
<p align="center" style='color:black;font-family:forte;font-size:50px'>this user is not registred</p><br>
<a href="SignUp.jsp"><button class="btn btn-outline btn-lg" type="submit">Create new account</button></a>
</body>
</html>