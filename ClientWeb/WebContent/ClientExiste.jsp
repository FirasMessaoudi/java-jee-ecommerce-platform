...
<p align="center" style='color:black;font-family:forte;font-size:50px'>Login or Email already exists if you are registred you just have to login !</p><br>
<a href="Login.jsp"><button class="btn btn-outline btn-lg" type="submit">Login</button></a>
</body>
</html>